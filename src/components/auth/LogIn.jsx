      ...
      <div className="flex justify-center items-center h-screen">
        <form className="bg-secondary rounded p-6 w-72 space-y-6">
          ...
          <div className="flex justify-between">
            <a href="#!" className="text-sm text-dark-subtle hover:text-white transition">Forgot Password?</a>
            <a href="#!" className="text-sm text-dark-subtle hover:text-white transition">Sign Up</a>
          </div>
        </form> 
      </div>
    </Container>
