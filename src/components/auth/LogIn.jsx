...
const LogIn = () => {
  return <div className="fixed inset-0 dark:bg-primary -z-10">
    <Container>
      <div className="flex justify-center items-center h-screen">
        <form className="dark:bg-secondary rounded p-6 space-y-6">
          ...
          <div className="flex justify-between">
            <a href="/forgot-password" className="text-sm dark:text-dark-subtle text-white hover:text-white transition">Forgot Password?</a>
